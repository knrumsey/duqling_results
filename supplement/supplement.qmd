...
header-includes:
  ...
  - \renewcommand{\thesubsection}{SM \arabic{section}.\arabic{subsection}}
  - \cftsetindents{section}{0em}{3.2em}
  - \cftsetindents{subsection}{3.2em}{4.2em}
  - \cftsetindents{subsubsection}{7.4em}{5.2em}
format:
  pdf:
...
## Summary of Emulator Performance
...
The average soft-relative scores give us a rough measure of practical performance. For emulator $i$ and simulation scenario $j$ we define $$t_{i,j} = \frac{\text{metric}_{i,j} + \epsilon}{\min_i\{\text{metric}_{i,j}\}+ \epsilon},$$ and the average soft-relative score is simply $$\text{Soft-Rel-Score}_i = J^{-1}\sum_{j=1}^J\min(t_{i,j}, \text{U})$$ where $\epsilon$ represents a point at which the metric should be considered practically $0$ and $U$ is a truncation point for robustness.
...
Additional columns may be present depending on the metrics and simulation options selected by the user (notably mean interval lengths and negatively oriented mean interval scores). The full results for the simulation studies shown in Section 4 are included in the associated GitHub repository.
...
| wind_speed | 200 | 17 | No | @edmunds2013value |
...
| ptw1 | 500 | 10 | No | @impala @preston2003model |
| discoflux_flyer | 914 | 6 | No | @francom2020simulation |
| taylor_foot | 962 | 11 | No | @biswas2021asc |
| taylor_length | 962 | 11 | No | @biswas2021asc |
| jc | 1000 | 5 | No | @impala @johnson1983constitutive |
| flyerPTW1 | 1000 | 11 | No | @biswas2021asc |
| flyerPTW2 | 1000 | 11 | No | @biswas2021asc |
| flyer_plate104 | 1000 | 11 | Yes | @walters2018bayesian |
...
| taylor_cylinder1 | 1438 | 8 | No | @sjue2023simple |
| stochastic_sir | 2000 | 4 | Yes | @rumsey2024generalized |
| diffusion_2D | 2000 | 53 | No | @hlobilova2024diffusion2d |
| acme_climate | 2980 | 66 | No | @sargsyan2015sparse |
| ptw2 | 3701 | 13 | No | @impala @preston2003model |
...
| icf1 | 10000 | 5 | No | @gaffney2020jag |
| icf2 | 10000 | 5 | No | @gaffney2020jag |
...
For these $60$ functions, we computed several characteristics of interest. Future work could try to link these characteristics (or others not listed here) to emulator performance. Determining, in advance, which surrogate modeling technique is likely to succeed on a given computer model would be of great use to practitioners. The R squared quantity refers to the $R^2$ statistic from a linear model fit to the input-output pairs of the computer model. For the other methods, gradients were estimated using automatic differentiation when possible. When needed, the gradient is approximated based on a BASS surrogate fit to the computer model. The AS Participation metric refers to the quantity $$(\sum_{i=1}^p \lambda_i)^2 / \sum_{i=1}^p \lambda_i^2,$$ where $\lambda_i$ is the $i$th eigenvalue of the active subspace matrix $C = E(\nabla f(x) \nabla f(x)^T)$.

| fname              | input_dim | Rsquared | MoransI | Sobolev | Participation |
|--------------------|----------:|---------:|--------:|--------:|--------------:|
| banana             |         2 |    0.035 |   0.955 |  11.017 |         1.232 |
| borehole           |         8 |    0.947 |   0.791 |   3.729 |         1.020 |
| cantilever_D       |         6 |    0.501 |   0.701 |   5.993 |         1.159 |
| cantilever_S       |         6 |    0.699 |   0.827 |   4.495 |         1.481 |
| circuit            |         6 |    0.973 |   0.855 |   3.869 |         1.104 |
| const_fn           |         1 |  0.00003 |   0.020 |   1.000 |               |
| const_fn15         |        15 |    0.001 |   0.001 |   1.000 |         1.271 |
| crater             |         7 |    0.647 |   0.758 |   5.090 |         1.621 |
| cube3              |         3 |    0.060 |   0.795 |  31.274 |         1.332 |
| cube3_rotate       |         3 |    0.198 |   0.797 |  10.383 |         2.355 |
| cube5              |         5 |    0.622 |   0.785 |  19.961 |         1.323 |
| detpep_curve       |         3 |    0.795 |   0.956 |   4.611 |         1.165 |
| detpep8            |         8 |    0.802 |   0.752 |   4.609 |         1.178 |
| dms_additive       |         2 |    0.058 |   0.984 |   9.895 |         1.918 |
| dms_complicated    |         2 |    0.192 |   0.962 |   9.831 |         1.941 |
| dms_harmonic       |         2 |    0.030 |   0.932 |  13.037 |         1.735 |
| dms_radial         |         2 |   0.0001 |   0.983 |   7.092 |         1.998 |
| dms_simple         |         2 |    0.189 |   0.948 |   4.768 |         1.966 |
| ebola              |         8 |    0.856 |   0.748 |   4.794 |         1.533 |
| forrester1         |         1 |    0.043 |   0.982 |  11.682 |             1 |
| foursquare         |         2 |    0.471 |   0.931 |  24.490 |         1.206 |
| friedman           |         5 |    0.770 |   0.877 |   4.856 |         2.717 |
| friedman10         |        10 |    0.742 |   0.674 |   5.064 |         2.666 |
| friedman20         |        20 |    0.753 |   0.675 |   4.961 |         2.674 |
| Gfunction          |         3 |   0.0001 |   0.883 |   1.000 |         2.803 |
| Gfunction18        |        18 |   0.0001 |   0.139 |   1.000 |         4.144 |
| Gfunction40        |        40 |    0.001 |   0.021 |   1.000 |         3.938 |
| Gfunction6         |         6 |    0.002 |   0.562 |   1.000 |         2.114 |
| grlee1             |         1 |    0.604 |   0.987 |  16.676 |             1 |
| grlee6             |         6 |    0.302 |   0.433 |  40.708 |         1.004 |
| higdon1            |         1 |    0.520 |   0.996 |  34.114 |               |
| ignition           |        10 |    0.815 |   0.729 |   3.937 |         2.695 |
| ishigami           |         3 |    0.199 |   0.841 |  11.257 |         2.380 |
| lim_non_polynomial |         2 |    0.643 |   0.974 |   5.532 |         1.814 |
| lim_polynomial     |         2 |    0.594 |   0.958 |   6.212 |         1.764 |
| linear21           |        21 |        1 |   0.569 |   3.620 |             1 |
| linear21_s1        |        21 |        1 |   0.572 |   3.605 |             1 |
| linear21_s10       |        21 |        1 |   0.594 |   3.591 |             1 |
| moon31             |        31 |    0.926 |   0.463 |   3.764 |         1.105 |
| multivalley        |         2 |    0.091 |   0.701 |  72.760 |         1.488 |
| onehundred         |       100 |    0.884 |   0.279 |   4.361 |         2.519 |
| oo15               |        15 |    0.258 |   0.574 |   1.000 |         7.538 |
| park4              |         4 |    0.955 |   0.919 |   3.655 |         1.075 |
| permdb             |        16 |   0.0004 |   0.101 |  46.941 |         9.681 |
| piston             |         7 |    0.914 |   0.819 |   4.093 |         1.270 |
| pollutant_uni      |         4 |    0.827 |   0.886 |   5.231 |         1.301 |
| quad4              |         4 |    0.938 |   0.920 |   3.826 |         1.226 |
| rabbits            |         3 |    0.927 |   0.954 |   4.710 |         1.072 |
| ripples            |         2 |    0.003 |   0.807 |  40.944 |         1.376 |
| robot              |         8 |    0.174 |   0.410 |   8.614 |         2.428 |
| sharkfin           |         3 |    0.246 |   0.753 |  41.910 |         2.246 |
| short_column       |         5 |    0.769 |   0.824 |   4.730 |         1.066 |
| squiggle           |         2 |    0.015 |   0.868 |  25.773 |         1.855 |
| star2              |         2 |    0.204 |   0.803 |  22.482 |         1.596 |
| steel_column       |         9 |    0.968 |   0.762 |   3.813 |         1.139 |
| sulfur             |         9 |    0.549 |   0.698 |   4.473 |         1.178 |
| turb12             |        12 |    0.335 |   0.463 |   7.659 |         1.758 |
| twin_galaxies      |         2 |    0.442 |   0.962 |   9.100 |         1.775 |
| welch20            |        20 |    0.598 |   0.598 |   6.375 |         2.097 |
| wingweight         |        10 |    0.984 |   0.758 |   3.652 |         1.061 |

## The Rashomon Effect and Ensembling
...
\sum_{i=1}^{n_{\mathrm{test}}}
(y_{\mathrm{test},i}-\bar y_{\mathrm{test}})^2
}
=
\frac{\mathrm{RMSE}^2}{s_y^2},
$$
where $s_y^2$ is the sample variance of the test responses and
$\hat y_1,\ldots,\hat y_{n_{\mathrm{test}}}$ are the emulator predictions.
...
for(i in 1:5){
  ...
  p <- heatmap_sim_study(tmp, metric="FVU", y_scale_fun = custom,
                    colorbar_labels = 
                      list(breaks=log10(c(0.001, 0.01,  0.1, 0.56, 1)),
